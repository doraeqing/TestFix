...
- (BOOL)encryptPlainScirptToDocument{
    ...
    
    {
        ...
        if (outErr) goto err;
        NSString *encryptedScriptString = [YTXMFRSA encryptString:plainScriptString publicKey:publicKey];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    YTXMFContext *context = [[YTXMFContext alloc] initWithRSAPrivateKey:privateKey];
