...
void mf_struct_data_with_dic(void *structData,NSDictionary *dic, YTXMFStructDeclare *declare){
	NSCAssert(declare, @"");
	...
	for (NSString *key in keys) {
		switch (encoding[index]) {
			...
			case '{':{
				...
				YTXMFStructDeclare *subStructDeclare = [[YTXMFStructDeclareTable shareInstance] getStructDeclareWithName:subStructName];
				...
				if ([subStruct isKindOfClass:[NSDictionary class]]) {
					...
					memcpy(structData+postion, [(YTXMFValue *)subStruct pointerValue], size);
				}
