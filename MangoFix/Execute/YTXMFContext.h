...
#import "YTXMFValue.h"
@interface YTXMFContext : NSObject
...
/**
 ...
 @result The YTXMFValue  for the global object's property.
 */
 ...
 */
- (void)setObject:(YTXMFValue *)value forKeyedSubscript:(NSObject <NSCopying> *)key;
