...
@property (strong, nonatomic) YTXMFInterpreter *inter;
@property (strong, nonatomic) MFMethodDefinition *method;

- (instancetype)initWithClass:(Class)clazz inter:(YTXMFInterpreter *)inter method:(MFMethodDefinition *)method;

@end

@interface YTXMFMethodMapTable : NSObject
